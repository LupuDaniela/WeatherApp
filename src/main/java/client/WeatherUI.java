...
//                showAlert("Error", "Latitude must be between -90 and 90, and Longitude must be between -180 and 180.");
//                return;
//            }
//
...
//                    showAlert("Error", "The selected file is empty.");
//                    return;
//                }
...
//            }
//
//            if (response.getData().toString().contains("ADMIN")) {
